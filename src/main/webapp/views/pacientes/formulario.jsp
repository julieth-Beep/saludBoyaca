...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Gradient border effect - SIN ANIMACIÓN */
        .form-card::before {
            content: '';
            position: absolute;
            inset: 0;
        ...
        /* Decorative corner accents - SIN ANIMACIÓN */
        .form-card::after {
            content: '';
            position: absolute;
            top: -50%; right: -50%;
...
<body>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-container">
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-list">
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/pacientes" class="nav-link active">
                                <i class="fas fa-users"></i><span><fmt:message key="nav.pacientes"/></span>
                            </a>
                        </li>
                        <c:if test="${sessionScope.usuarioRol != 'ENFERMERO'}">
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/citas" class="nav-link">
                                <i class="fas fa-calendar-check"></i><span><fmt:message key="nav.citas"/></span>
                            </a>
                        </li>
                        </c:if>
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/horarios" class="nav-link">
                                <i class="fas fa-clock"></i><span><fmt:message key="nav.horarios"/></span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="form-body">
                        <form action="${pageContext.request.contextPath}/pacientes" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="nombres" class="form-control"
                                               ...
                                               placeholder="Ej: Carlos Ernesto" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="apellidos" class="form-control"
                                               ...
                                               placeholder="Ej: Pedraza Rondón" required>
                                        <i class="fas fa-user"></i>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="documento" class="form-control"
                                               ...
                                               ${not empty paciente ? 'readonly' : ''} required>
                                        <i class="fas fa-fingerprint"></i>
                                    </div>
                                    <c:if test="${not empty paciente}">
                                        <small style="color: var(--text-muted); font-size: 0.75rem; display: flex; align-items: center; gap: 4px;">
                                            <i class="fas fa-lock" style="font-size: 0.7rem;"></i> Documento no editable
                                        </small>
                                    </c:if>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="eps" class="form-control"
                                               value="${paciente.eps}"
                                               placeholder="Ej: Sanitas, Compensar" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <input type="text" name="veredaBarrio" class="form-control"
                                               ...
                                               placeholder="Ej: Centro, El Salitre">
                            ...
                            <div class="form-actions">
                                ...
                                <a href="${pageContext.request.contextPath}/pacientes" class="btn-secondary">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const firstInput = document.querySelector('.form-control:not([readonly])');
            if (firstInput) {
